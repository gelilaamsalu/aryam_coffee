...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $conn->prepare("INSERT INTO tblmenu (title,price,discount, description, photo) VALUES (?, ?, ?,?, ?)");
  $stmt->bind_param("sssss", $title,$price,$discount, $description, $fileName);
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <label>
          ...
          <input
            type="text"
            class="input"
            name="discount" autocomplete="off" optional
